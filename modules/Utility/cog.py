...
class Utility(commands.Cog):
    ...
    async def create_announcement(self, interaction: discord.Interaction, brief_description: str, message: str):
        ...
        dic = {
            ...
            "Time_Created": interaction.created_at.astimezone(pytz.timezone('US/Eastern')).strftime('%m/%d/%Y at %I:%M %p')
        }
        ...
        await interaction.response.send_message("Thank you for your announcement, a mod will review and approve it shortly.")
